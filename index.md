...
A fifth one to simulate auditory scenes data for large neural networks training (<A HREF="https://ieee-dataport.org/open-access/audio-dataset-household-multimodal-environment-home"> the CLEAR dataset </A>). It is a collection of audio scenes that we created through the CLEAR software.
